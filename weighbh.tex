...
\begin{abstract}
  ...
  limit is much weaker with $|\eta_N|<5.9$.  The constraints from
...
\begin{equation}
  ...
  \label{eq:5}
\end{equation}
from n-body simulations that treat the perturbation of the stellar system
...
constraint $|\Delta|<0.08$.  In fact the maximal distance between
...
constraints on $\Delta$ would be much weaker with $\Delta<0.75$.
...
$-1<\Delta<0.3$, assuming the more conservative displacement estimate
